        ...
        2: [
            function(t, e, r) {
                ...
                (a.prototype.clearData = function(t) {
                    t
                        ? (delete this.dataByFormat[t], n(this.types, t))
                        : ((this.dataByFormat = {}), (this.types = []));
                }),
                    ...
                    (a.prototype.setData = function(t, e) {
                        return (
                            (this.dataByFormat[t] = e),
                            this.types.indexOf(t) < 0 && this.types.push(t),
                            !0
                        );
                    }),
        ...
        3: [
            function(t, e, r) {
                ...
                (c.prototype._queue = function(t) {
                    this.pendingActionsQueue.push(t),
                        1 === this.pendingActionsQueue.length &&
                        ...
                        return (
                            this._queue(function() {
                                i(
                                    ...
                                    (this.lastDragSource = t),
                                    (this.lastDataTransfer = u);
                            }),
                            this
                        );
                    }),
        ...
        4: [
            function(t, e, r) {
                ...
                function a(t, e, r) {
                    ...
                    var a = window[e],
                        o = { view: window, bubbles: !0, cancelable: !0 };
                    n(o, r);
                    var i = new a(t, o);
                    return n(i, r), i;
                }
