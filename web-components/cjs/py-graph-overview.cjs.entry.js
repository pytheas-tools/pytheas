...
const GraphOverview = class {
    constructor(hostRef) {
        ...
        this.graphOverviewDetailSelected = core.createEvent(this, "graphOverviewDetailSelected", 7);
    ...
    renderListOfElements(elements) {
        ...
        elements.map(element => {
            lines.push(core.h("li", { class: 'graph-overview__type ' + this.selectedType, onClick: this.openElement.bind(this, element), onTouchStart: this.openElement.bind(this, element) }, element.name));
        });
        return lines;
    }
    renderInternal() {
        if (this.inDetailList) {
            return (core.h("div", { class: "graph-overview__type-list" }, core.h("div", { class: "graph-overview__type-list__spacer" }, core.h("div", { class: "title" }, this.getPluralForType(this.selectedType)), core.h("ul", null, Object.keys(this.selectedElements).map(key => (core.h("li", null, core.h("span", { class: "letter-group" }, key), core.h("ul", { class: "elements" }, this.renderListOfElements(this.selectedElements[key].elements)))))))));
        }
        else {
            return (core.h("ul", { class: "graph-overview__types-list" }, this.data.file.length > 0
                ? /*<li
                ...
                >
                    ...
                    ''
                : '', this.data.class.length > 0 ? (core.h("li", { class: "graph-overview__type class", "data-badge": this.data.class.length, onClick: this.selectType.bind(this), onTouchStart: this.selectType.bind(this), "data-type": "class" }, "Classes")) : (''), this.data.function.length > 0
                ? /*<li
...
exports.py_graph_overview = GraphOverview;
