...
const NavigationBar = class {
    constructor(hostRef) {
        ...
        this.navigationBarBackEvent = core.createEvent(this, "navigationBarBackEvent", 7);
        this.navigationBarHomeEvent = core.createEvent(this, "navigationBarHomeEvent", 7);
        this.navigationBarNextEvent = core.createEvent(this, "navigationBarNextEvent", 7);
    }
    back() {
